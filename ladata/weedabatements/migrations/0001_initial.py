...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WeedAbatement'
        db.create_table(u'weedabatements_weedabatement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ain', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('no_clean', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('lien', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2, blank=True)),
            ('vacant', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'weedabatements', ['WeedAbatement'])


    def backwards(self, orm):
        # Deleting model 'WeedAbatement'
        db.delete_table(u'weedabatements_weedabatement')
    ...
    models = {
        ...
        u'weedabatements.weedabatement': {
            'Meta': {'object_name': 'WeedAbatement'},
            'added': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'ain': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lien': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '2', 'blank': 'True'}),
            'no_clean': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
