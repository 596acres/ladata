...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'parcels_localrollaentry', (
        ...
        db.send_create_signal(u'parcels', ['LocalRollAEntry'])

        # Adding field 'Parcel.local_roll'
        db.add_column(u'parcels_parcel', 'local_roll',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['localroll.LocalRollAEntry'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'LocalRollAEntry'
        db.delete_table(u'parcels_localrollaentry')

        # Deleting field 'Parcel.local_roll'
        db.delete_column(u'parcels_parcel', 'local_roll_id')
